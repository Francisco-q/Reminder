"""
Base settings for Medication Reminder API
...
# Application definition - Organized by vertical slices
DJANGO_APPS = [
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API para aplicación de recordatorio de medicamentos',
    'VERSION': '1.0.0',
